...
echo "    ${KC_HOST}/realms/${REALM}/.well-known/openid-configuration"
echo ""
echo "  Client ID:      $CLIENT_ID"
echo "  Client Secret:  $CLIENT_SECRET"
echo ""
echo "  Authorization:  ${KC_HOST}/realms/${REALM}/protocol/openid-connect/auth"
...
echo "    Client ID:         $CLIENT_ID"
echo "    Client Secret:     $CLIENT_SECRET"
echo "    Authorization URL: ${KC_HOST}/realms/${REALM}/protocol/openid-connect/auth"
echo "    Token URL:         ${KC_HOST}/realms/${REALM}/protocol/openid-connect/token"
echo "    Userinfo URL:      ${KC_HOST}/realms/${REALM}/protocol/openid-connect/userinfo"
