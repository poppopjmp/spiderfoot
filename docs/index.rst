...
SpiderFoot 5.2.9 introduces powerful new workflow capabilities including multi-target scanning, workspace management, cross-correlation analysis, and CTI report generation with MCP integration.
