...
Each rule exists as a YAML file within the `/correlations` folder in the SpiderFoot installation path. There are **95 correlation rules** covering network, infrastructure, identity, vulnerability, data leak, geographic, cryptocurrency, web, social media, and cross-scan workspace analysis:
