...
"""SpiderFoot plug-in module: grep_app."""
...
class sfp_grep_app(SpiderFootAsyncPlugin):
    ...
    def query(self, qry: str, page: int) -> dict | None:
        ...
        res = self.fetch_url("https://grep.app/api/search?" + urllib.parse.urlencode(params),
    ...
    def handleEvent(self, event: SpiderFootEvent) -> None:
        ...
        while page <= pages:
            ...
            for result in data:
                ...
                links = SpiderFootHelpers.extractUrlsFromText(
