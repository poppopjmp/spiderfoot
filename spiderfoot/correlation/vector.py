...
log = logging.getLogger("spiderfoot.correlation.vector")
...
class VectorCorrelationEngine:
    ...
    Usage::
        ...
        from spiderfoot.ai.qdrant_client import QdrantClient
        from spiderfoot.services.embedding_service import EmbeddingService
        from spiderfoot.ai.rag_pipeline import RAGPipeline
    ...
    def _correlate_similarity(self, query: str,
        ...
        # Build filter
        from spiderfoot.ai.qdrant_client import Filter
        filter_ = None
    ...
    def _rag_analyze(self, query: str,
        ...
        try:
            from spiderfoot.ai.rag_pipeline import RetrievedChunk, MockRetriever
