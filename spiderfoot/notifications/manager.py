...
log = logging.getLogger("spiderfoot.notifications.channels")
...
class NotificationManager:
    ...
    def wire_task_manager(self) -> None:
        ...
        try:
            from spiderfoot.ops.task_queue import get_task_manager
    ...
    def wire_alert_engine(self, engine: Any | None = None) -> None:
        ...
        try:
            if engine is None:
                from spiderfoot.notifications.alerts import AlertEngine
                engine = AlertEngine()
