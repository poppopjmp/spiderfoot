...
class DbCore:
    ...
    eventDetails = [
        # --- Internal ---
        ("ROOT", "Internal root event", 1, "INTERNAL"),
        ...
        ("EMAILADDR_COMPROMISED", "Compromised email address", 0, "DESCRIPTOR"),
        ...
        ("PHONE_NUMBER_COMPROMISED", "Compromised phone number", 0, "DESCRIPTOR"),
        ...
        ("ACCOUNT_EXTERNAL_OWNED_COMPROMISED", "Compromised external account", 0, "DESCRIPTOR"),
        ...
        ("AFFILIATE_DOMAIN_NAME", "Affiliated domain name", 0, "ENTITY"),
        ("AFFILIATE_DOMAIN_UNREGISTERED", "Unregistered affiliate domain", 0, "ENTITY"),
        ("AFFILIATE_DOMAIN_WHOIS", "Affiliate domain WHOIS data", 1, "DATA"),
        ("AFFILIATE_EMAILADDR", "Affiliate email address", 0, "ENTITY"),
        ("AFFILIATE_INTERNET_NAME", "Affiliate hostname", 0, "ENTITY"),
        ("AFFILIATE_INTERNET_NAME_HIJACKABLE", "Hijackable affiliate hostname", 0, "ENTITY"),
        ("AFFILIATE_IPADDR", "Affiliate IP address", 0, "ENTITY"),
        ("AFFILIATE_IPV6_ADDRESS", "Affiliate IPv6 address", 0, "ENTITY"),
        ("AFFILIATE_WEB_CONTENT", "Affiliate web page content", 1, "DATA"),
        ...
        ("DOMAIN_WHOIS", "Domain WHOIS data", 1, "DATA"),
        ("SIMILARDOMAIN_WHOIS", "Similar domain WHOIS data", 1, "DATA"),
        ("NETBLOCK_WHOIS", "Netblock WHOIS data", 1, "DATA"),
        ("PROVIDER_DNS", "DNS provider", 0, "DESCRIPTOR"),
        ("PROVIDER_HOSTING", "Hosting provider", 0, "ENTITY"),
        ("PROVIDER_JAVASCRIPT", "JavaScript CDN provider", 0, "ENTITY"),
        ("PROVIDER_MAIL", "Mail provider", 0, "DESCRIPTOR"),
        ("PROVIDER_TELCO", "Telecom provider", 0, "ENTITY"),
        ("CARRIER_NAME", "Phone carrier name", 0, "ENTITY"),
        ("CARRIER_TYPE", "Phone carrier type", 0, "DESCRIPTOR"),
        # --- Web Descriptors ---
        ("WEBSERVER_BANNER", "Web server banner", 0, "DATA"),
        ("WEBSERVER_HTTPHEADERS", "HTTP response headers", 1, "DATA"),
        ("WEBSERVER_STRANGEHEADER", "Unusual HTTP header", 0, "DATA"),
        ("WEBSERVER_TECHNOLOGY", "Web technology detected", 0, "DESCRIPTOR"),
        ("HTTP_CODE", "HTTP status code", 0, "DATA"),
        ("WEB_ANALYTICS_ID", "Web analytics tracking ID", 0, "ENTITY"),
        ("CDN_DETECTED", "CDN detected", 0, "DESCRIPTOR"),
        # --- SSL/TLS ---
        ("SSL_CERTIFICATE_ISSUED", "SSL certificate details", 0, "ENTITY"),
        ("SSL_CERTIFICATE_ISSUER", "SSL certificate issuer", 0, "ENTITY"),
        ...
        ("TCP_PORT_OPEN_BANNER", "TCP port service banner", 0, "DATA"),
        ("UDP_PORT_OPEN", "Open UDP port", 0, "SUBENTITY"),
        ("UDP_PORT_OPEN_INFO", "UDP port service information", 0, "DATA"),
        # --- Cloud ---
        ...
        ("CLOUD_STORAGE_BUCKET_OPEN", "Open cloud storage bucket", 0, "DESCRIPTOR"),
        ("CLOUD_STORAGE_OPEN", "Open cloud storage", 0, "DESCRIPTOR"),
        # --- System / Software ---
        ("OPERATING_SYSTEM", "Operating system", 0, "DESCRIPTOR"),
        ("SOFTWARE_USED", "Software detected", 0, "SUBENTITY"),
        ...
        ("COUNTRY_NAME", "Country", 0, "ENTITY"),
        ("REGION_NAME", "Region/state", 0, "ENTITY"),
        ("PHYSICAL_ADDRESS", "Physical address", 0, "ENTITY"),
        ("PHYSICAL_COORDINATES", "GPS coordinates", 0, "ENTITY"),
        # --- URLs ---
        ("LINKED_URL_INTERNAL", "Internal URL", 0, "SUBENTITY"),
        ("LINKED_URL_EXTERNAL", "External URL", 0, "SUBENTITY"),
        ("URL_FORM", "Web form URL", 0, "DESCRIPTOR"),
        ("URL_UPLOAD", "File upload URL", 0, "DESCRIPTOR"),
        ("URL_JAVASCRIPT", "JavaScript resource URL", 0, "DESCRIPTOR"),
        ("URL_WEB_FRAMEWORK", "Web framework URL", 0, "DESCRIPTOR"),
        ("URL_WEB", "Web page URL", 0, "ENTITY"),
        ("URL_STATIC", "Static resource URL", 0, "DESCRIPTOR"),
        ("URL_DIRECTORY", "Directory listing URL", 0, "ENTITY"),
        ("URL_ADBLOCKED_EXTERNAL", "Ad-blocked external URL", 0, "DESCRIPTOR"),
        ("URL_ADBLOCKED_INTERNAL", "Ad-blocked internal URL", 0, "DESCRIPTOR"),
        # --- Vulnerability ---
        ...
        ("HASH_COMPROMISED", "Compromised hash", 0, "DATA"),
        ...
        ("DARKNET_MENTION_URL", "Dark web mention URL", 0, "DESCRIPTOR"),
        ...
        ("TARGET_WEB_COOKIE", "Web cookie", 0, "DATA"),
        ("SEARCH_ENGINE_WEB_CONTENT", "Search engine result content", 1, "DATA"),
        ("DOCUMENT_TEXT", "Extracted document text", 0, "DATA"),
        ...
        ("BLOCKCHAIN_ANALYSIS", "Blockchain analysis result", 0, "DATA"),
        ...
        ("ACCOUNT_EXTERNAL_USER_SHARED_COMPROMISED", "Compromised shared external account", 0, "DESCRIPTOR"),
        ("AFFILIATE_INTERNET_NAME_UNRESOLVED", "Unresolved affiliate hostname", 0, "ENTITY"),
        ("AFFILIATE_COMPANY_NAME", "Affiliate company name", 0, "ENTITY"),
        ("AFFILIATE_DESCRIPTION_CATEGORY", "Affiliate entity category", 0, "DESCRIPTOR"),
        ("AFFILIATE_DESCRIPTION_ABSTRACT", "Affiliate entity abstract", 0, "DESCRIPTOR"),
        ("APPSTORE_ENTRY", "App store entry", 0, "ENTITY"),
        ("CO_HOSTED_SITE_DOMAIN", "Co-hosted site domain", 0, "ENTITY"),
        ("CO_HOSTED_SITE_DOMAIN_WHOIS", "Co-hosted site domain WHOIS data", 1, "DATA"),
        ("DESCRIPTION_CATEGORY", "Entity category/classification", 0, "DESCRIPTOR"),
        ("ERROR_MESSAGE", "Error/warning message", 0, "DATA"),
        ("HASH", "File/data hash", 0, "DATA"),
        ("PERSON_NAME", "Person name (legacy)", 0, "ENTITY"),
        ("PHONE_NUMBER_TYPE", "Phone number type", 0, "DESCRIPTOR"),
        # --- Historic URL variants ---
        ("URL_FLASH", "Flash content URL", 0, "DESCRIPTOR"),
        ("URL_JAVA_APPLET", "Java applet URL", 0, "DESCRIPTOR"),
        ("URL_PASSWORD", "Password-containing URL", 0, "DESCRIPTOR"),
        ("URL_FILE", "File URL", 0, "ENTITY"),
        ("URL_FORM_HISTORIC", "Historic form URL", 0, "DESCRIPTOR"),
        ("URL_FLASH_HISTORIC", "Historic Flash URL", 0, "DESCRIPTOR"),
        ("URL_JAVASCRIPT_HISTORIC", "Historic JavaScript URL", 0, "DESCRIPTOR"),
        ("URL_WEB_FRAMEWORK_HISTORIC", "Historic web framework URL", 0, "DESCRIPTOR"),
        ("URL_JAVA_APPLET_HISTORIC", "Historic Java applet URL", 0, "DESCRIPTOR"),
        ("URL_STATIC_HISTORIC", "Historic static resource URL", 0, "DESCRIPTOR"),
        ("URL_PASSWORD_HISTORIC", "Historic password URL", 0, "DESCRIPTOR"),
        ("URL_UPLOAD_HISTORIC", "Historic upload URL", 0, "DESCRIPTOR"),
        ...
        # --- Documents / user data ---
        # NOTE: event_type/event_raw below are kept consistent with the
        # canonical catalog in spiderfoot/db/__init__.py (SpiderFootDb.eventDetails),
        # which is upserted last and therefore wins at runtime. Keeping these in
        # sync avoids the static list here disagreeing with the live table.
        ("DOCUMENT_UPLOAD", "Uploaded document", 0, "DATA"),
        ("REPORT_UPLOAD", "Uploaded report", 0, "DATA"),
        ("USER_DOCUMENT", "User document", 0, "DATA"),
        ("USER_INPUT_DATA", "User-supplied input data", 0, "DATA"),
        ...
        ("SOCIAL_MEDIA_NETWORK", "Social media network identified", 0, "ENTITY"),
        ...
        ("UNWIREDLABS_GEOINFO", "UnwiredLabs geolocation data", 0, "DATA"),
        # --- Threat intelligence / correlation ---
        ("THREAT_INTELLIGENCE", "Threat intelligence data", 0, "DESCRIPTOR"),
        ("CORRELATION_ANALYSIS", "Correlation analysis result", 0, "DATA"),
        # --- Performance / monitoring ---
        ("PERFORMANCE_STATS", "Performance statistics", 1, "DATA"),
        ("CACHE_STATS", "Cache statistics", 1, "DATA"),
        ("RESOURCE_USAGE", "Resource usage data", 1, "DATA"),
