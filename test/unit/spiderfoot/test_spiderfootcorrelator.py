...
from test.unit.modules.test_module_base import (
    SpiderFootModuleTestCase,
)  # Add this import
...
class TestSpiderFootCorrelator(SpiderFootModuleTestCase):
    ...
    def test_collect_from_db(self):
        matchrule = {"field": "type", "method": "exact", "value": "IP_ADDRESS"}
    ...
    def test_event_extract(self):
        event = {"field": "value", "subfield": [{"field": "subvalue"}]}
    ...
    def test_collect_events(self):
        collection = {
            "collect": [{"field": "type", "method": "exact", "value": "IP_ADDRESS"}]
        }
        self.dbh.scanResultEvent.return_value = [
            [None, "data", None, "module", "type", None, None, None, "id"]
        ]
    ...
    def test_build_correlation_title(self):
        rule = {"headline": "Test Rule Headline", "id": "rule1"}
        data = [{"field": "value"}]
    ...
    def test_create_correlation(self):
        rule = {
            "id": "rule1",
            "meta": {"name": "Test Rule", "description": "A test rule", "risk": 1},
            "rawYaml": "",
        }
        data = [{"id": "event1"}]
    ...
    def test_analysis_first_collection_only(self):
        rule = {"method": "first_collection_only", "field": "type"}
        buckets = {
            "bucket1": [{"type": "IP_ADDRESS", "_collection": 0}],
            "bucket2": [{"type": "IP_ADDRESS", "_collection": 1}],
        }
    ...
    def test_analyze_rule_scope(self):
        rule = {
            ...
            "analysis": [
                {"method": "threshold", "field": "type", "minimum": 1, "maximum": 10}
            ],
        }
