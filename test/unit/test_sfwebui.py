...
class TestSpiderFootWebUi(unittest.TestCase):
    ...
    def test_start_scan_invalid_scanname_should_return_error(self):
        ...
        sfwebui = SpiderFootWebUi(self.web_default_options, opts)
        start_scan = sfwebui.startscan(
            None, "example scan target", None, None, None)
        self.assertIn(
            "Invalid request: scan name was not specified.", start_scan)
        start_scan = sfwebui.startscan(
            "", "example scan target", None, None, None)
        self.assertIn(
            "Invalid request: scan name was not specified.", start_scan)
    ...
    def test_start_scan_invalid_scantarget_should_return_error(self):
        ...
        sfwebui = SpiderFootWebUi(self.web_default_options, opts)
        start_scan = sfwebui.startscan(
            "example scan name", None, None, None, None)
        self.assertIn(
            "Invalid request: scan target was not specified.", start_scan)
        start_scan = sfwebui.startscan(
            "example scan name", "", None, None, None)
        self.assertIn(
            "Invalid request: scan target was not specified.", start_scan)
    ...
    def test_start_scan_invalid_modules_should_return_error(self):
        ...
        self.assertIn(
            "Invalid request: no modules specified for scan.", start_scan)
        start_scan = sfwebui.startscan(
    ...
    def test_stopscan_invalid_scanid_should_return_an_error(self):
        ...
        self.assertEqual(
            "Scan example scan id does not exist", stop_scan.get(
                "error").get("message")
        )
    ...
    def test_scan_history_missing_scanid_should_return_error(self):
        ...
        self.assertEqual("No scan specified",
                         scan_history.get("error").get("message"))
