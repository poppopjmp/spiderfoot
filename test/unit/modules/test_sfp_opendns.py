# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_opendns.py
...
class TestModuleOpendns(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_opendns",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_opendns, module_attributes=module_attributes
        )
