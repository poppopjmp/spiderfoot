# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_digitaloceanspace.py
...
class TestModuleDigitaloceanspace(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_digitaloceanspace",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_digitaloceanspace, module_attributes=module_attributes
        )
