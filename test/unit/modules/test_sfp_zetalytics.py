# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_zetalytics.py
...
class TestModuleZetalytics(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_zetalytics",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_zetalytics, module_attributes=module_attributes
        )
