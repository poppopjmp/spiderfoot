# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_uceprotect.py
...
class TestModuleUceprotect(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_uceprotect",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_uceprotect, module_attributes=module_attributes
        )
