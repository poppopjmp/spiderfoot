# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_focsec.py
...
class TestModuleFocsec(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_focsec",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_focsec, module_attributes=module_attributes
        )
