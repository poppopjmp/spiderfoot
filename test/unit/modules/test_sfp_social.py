# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_social.py
...
class TestModuleSocial(SpiderFootModuleTestCase):
    """Test Social module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_social",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_social, module_attributes=module_attributes
        )
