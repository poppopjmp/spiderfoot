# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dnsneighbor.py
...
class TestModuleDnsneighbor(SpiderFootModuleTestCase):
    """Test Dnsneighbor module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dnsneighbor",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dnsneighbor, module_attributes=module_attributes
        )
