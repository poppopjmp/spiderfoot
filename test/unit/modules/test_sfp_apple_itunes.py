# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_apple_itunes.py
...
class TestModuleAppleItunes(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_apple_itunes",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_apple_itunes, module_attributes=module_attributes
        )
