# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_filemeta.py
...
class TestModuleFilemeta(SpiderFootModuleTestCase):
    """Test Filemeta module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_filemeta",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_filemeta, module_attributes=module_attributes
        )
