# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_punkspider.py
...
class TestModulePunkspider(SpiderFootModuleTestCase):
    """Test Punkspider module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_punkspider",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_punkspider, module_attributes=module_attributes
        )
