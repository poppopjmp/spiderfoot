# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_wigle.py
...
class TestModuleWigle(SpiderFootModuleTestCase):
    """Test Wigle module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_wigle",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_wigle, module_attributes=module_attributes
        )
