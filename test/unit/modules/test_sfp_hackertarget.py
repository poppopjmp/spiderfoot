# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_hackertarget.py
...
class TestModulehAckertarget(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_hackertarget",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_hackertarget, module_attributes=module_attributes
        )
