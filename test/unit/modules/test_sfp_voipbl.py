# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_voipbl.py
...
class TestModuleVoipbl(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_voipbl",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_voipbl, module_attributes=module_attributes
        )
