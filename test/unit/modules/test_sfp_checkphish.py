# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_checkphish.py
...
class TestModuleCheckphish(SpiderFootModuleTestCase):
    """Test Checkphish module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_checkphish",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_checkphish, module_attributes=module_attributes
        )
