# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_ipinfo.py
...
class TestModuleiPinfo(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_ipinfo",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_ipinfo, module_attributes=module_attributes
        )
