# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_intelx.py
...
class TestModuleiNtelx(SpiderFootModuleTestCase):
    """Test I Ntelx module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_intelx",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_intelx, module_attributes=module_attributes
        )
