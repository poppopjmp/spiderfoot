# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_subdomain_takeover.py
...
class TestModuleSubdomainTakeover(SpiderFootModuleTestCase):
    """Test Subdomain Takeover module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_subdomain_takeover",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_subdomain_takeover, module_attributes=module_attributes
        )
