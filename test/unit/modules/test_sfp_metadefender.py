# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_metadefender.py
...
class TestModuleMetadefender(SpiderFootModuleTestCase):
    """Test Metadefender module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_metadefender",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_metadefender, module_attributes=module_attributes
        )
