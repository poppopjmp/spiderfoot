# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_emailformat.py
...
class TestModuleEmailformat(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_emailformat",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_emailformat, module_attributes=module_attributes
        )
