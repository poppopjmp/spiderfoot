# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_threatminer.py
...
class TestModuleThreatminer(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_threatminer",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_threatminer, module_attributes=module_attributes
        )
