# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_similar.py
...
class TestModuleSimilar(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_similar",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_similar, module_attributes=module_attributes
        )
