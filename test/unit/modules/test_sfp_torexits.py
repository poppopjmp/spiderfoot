# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_torexits.py
...
class TestModuleTorexits(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_torexits",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_torexits, module_attributes=module_attributes
        )
