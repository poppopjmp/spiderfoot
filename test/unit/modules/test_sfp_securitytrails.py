# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_securitytrails.py
...
class TestModuleSecuritytrails(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_securitytrails",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_securitytrails, module_attributes=module_attributes
        )
