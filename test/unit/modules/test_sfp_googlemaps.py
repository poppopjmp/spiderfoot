# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_googlemaps.py
...
class TestModuleGooglemaps(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_googlemaps",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_googlemaps, module_attributes=module_attributes
        )
