# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp__stor_db.py
...
class TestModuleStorDb(SpiderFootModuleTestCase):
    """Test Stor Db module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp__stor_db",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp__stor_db, module_attributes=module_attributes
        )
