# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_shodan.py
...
class TestModuleShodan(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_shodan",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_shodan, module_attributes=module_attributes
        )
