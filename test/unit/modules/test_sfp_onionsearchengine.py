# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_onionsearchengine.py
...
class TestModuleOnionsearchengine(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_onionsearchengine",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_onionsearchengine, module_attributes=module_attributes
        )
