# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_abusix.py
...
class TestModuleAbusix(SpiderFootModuleTestCase):
    """Test Abusix module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_abusix",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_abusix, module_attributes=module_attributes
        )
