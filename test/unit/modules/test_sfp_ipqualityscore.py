# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_ipqualityscore.py
...
class TestModuleiPqualityscore(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_ipqualityscore",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_ipqualityscore, module_attributes=module_attributes
        )
