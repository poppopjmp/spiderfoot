# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_openphish.py
...
class TestModuleOpenphish(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_openphish",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_openphish, module_attributes=module_attributes
        )
