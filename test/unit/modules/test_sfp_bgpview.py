# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_bgpview.py
...
class TestModuleBgpview(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_bgpview",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_bgpview, module_attributes=module_attributes
        )
