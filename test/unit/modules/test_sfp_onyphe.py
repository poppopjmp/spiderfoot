# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_onyphe.py
...
class TestModuleOnyphe(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_onyphe",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_onyphe, module_attributes=module_attributes
        )
