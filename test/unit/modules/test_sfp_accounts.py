# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_accounts.py
...
class TestModuleAccounts(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_accounts",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_accounts, module_attributes=module_attributes
        )
