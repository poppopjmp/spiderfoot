# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_maltiverse.py
...
class TestModuleMaltiverse(SpiderFootModuleTestCase):
    """Test Maltiverse module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_maltiverse",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_maltiverse, module_attributes=module_attributes
        )
