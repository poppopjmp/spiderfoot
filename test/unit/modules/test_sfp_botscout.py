# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_botscout.py
...
class TestModuleBotscout(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_botscout",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_botscout, module_attributes=module_attributes
        )
