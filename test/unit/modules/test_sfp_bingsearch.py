# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_bingsearch.py
...
class TestModuleBingsearch(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_bingsearch",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_bingsearch, module_attributes=module_attributes
        )
