# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_blockchain.py
...
class TestModuleBlockchain(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_blockchain",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_blockchain, module_attributes=module_attributes
        )
