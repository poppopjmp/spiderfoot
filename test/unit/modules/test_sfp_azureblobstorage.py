# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_azureblobstorage.py
...
class TestModuleAzureblobstorage(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_azureblobstorage",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_azureblobstorage, module_attributes=module_attributes
        )
