# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_vxvault.py
...
class TestModuleVxvault(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_vxvault",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_vxvault, module_attributes=module_attributes
        )
