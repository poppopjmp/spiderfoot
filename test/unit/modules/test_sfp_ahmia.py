# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_ahmia.py
...
class TestModuleAhmia(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_ahmia",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_ahmia, module_attributes=module_attributes
        )
