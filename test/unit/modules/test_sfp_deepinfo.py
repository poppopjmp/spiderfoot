# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_deepinfo.py
...
class TestModuleDeepinfo(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_deepinfo",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_deepinfo, module_attributes=module_attributes
        )
