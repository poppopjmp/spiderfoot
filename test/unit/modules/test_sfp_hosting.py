# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_hosting.py
...
class TestModulehOsting(SpiderFootModuleTestCase):
    """Test H Osting module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_hosting",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_hosting, module_attributes=module_attributes
        )
