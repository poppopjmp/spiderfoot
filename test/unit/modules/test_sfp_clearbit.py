# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_clearbit.py
...
class TestModuleClearbit(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_clearbit",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_clearbit, module_attributes=module_attributes
        )
