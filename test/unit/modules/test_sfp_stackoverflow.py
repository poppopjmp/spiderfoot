# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_stackoverflow.py
...
class TestModuleStackoverflow(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_stackoverflow",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_stackoverflow, module_attributes=module_attributes
        )
