# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_hashes.py
...
class TestModulehAshes(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_hashes",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_hashes, module_attributes=module_attributes
        )
