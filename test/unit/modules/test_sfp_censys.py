# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_censys.py
...
class TestModuleCensys(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_censys",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_censys, module_attributes=module_attributes
        )
