# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_abuseipdb.py
...
class TestModuleAbuseipdb(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_abuseipdb",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_abuseipdb, module_attributes=module_attributes
        )
