# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_alienvaultiprep.py
...
class TestModuleAlienvaultiprep(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_alienvaultiprep",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_alienvaultiprep, module_attributes=module_attributes
        )
