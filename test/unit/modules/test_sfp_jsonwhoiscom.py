# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_jsonwhoiscom.py
...
class TestModuleJsonwhoiscom(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_jsonwhoiscom",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_jsonwhoiscom, module_attributes=module_attributes
        )
