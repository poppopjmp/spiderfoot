# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dnsraw.py
...
class TestModuleDnsraw(SpiderFootModuleTestCase):
    """Test Dnsraw module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dnsraw",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dnsraw, module_attributes=module_attributes
        )
