# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_numverify.py
...
class TestModuleNumverify(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_numverify",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_numverify, module_attributes=module_attributes
        )
