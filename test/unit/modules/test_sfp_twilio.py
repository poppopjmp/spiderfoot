# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_twilio.py
...
class TestModuleTwilio(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_twilio",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_twilio, module_attributes=module_attributes
        )
