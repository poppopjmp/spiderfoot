# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_pgp.py
...
class TestModulePgp(SpiderFootModuleTestCase):
    """Test Pgp module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_pgp",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_pgp, module_attributes=module_attributes
        )
