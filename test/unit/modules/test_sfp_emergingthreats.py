# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_emergingthreats.py
...
class TestModuleEmergingthreats(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_emergingthreats",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_emergingthreats, module_attributes=module_attributes
        )
