# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_junkfiles.py
...
class TestModuleJunkfiles(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_junkfiles",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_junkfiles, module_attributes=module_attributes
        )
