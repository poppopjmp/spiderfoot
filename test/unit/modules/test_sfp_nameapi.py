# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_nameapi.py
...
class TestModuleNameapi(SpiderFootModuleTestCase):
    """Test Nameapi module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_nameapi",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_nameapi, module_attributes=module_attributes
        )
