# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_spamcop.py
...
class TestModuleSpamcop(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_spamcop",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_spamcop, module_attributes=module_attributes
        )
