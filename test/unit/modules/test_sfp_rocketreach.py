    ...
    def test_handleEvent_with_api_key_should_make_api_request(self):
        ...
        def fetchUrl_mock(url, *args, **kwargs):
            if 'lookup' in url:
                return {
                    'code': 200,
                    'content': '{"name": "John Smith", "current_title": "CEO", "current_employer": "Example Inc", "email": "john@example.com", "linkedin_url": "https://linkedin.com/in/johnsmith"}'
                }
            return {
                'code': 200,
                'content': '{"profiles": [{"name": "John Smith", "current_title": "CEO", "current_employer": "Example Inc", "email": "john@example.com", "linkedin_url": "https://linkedin.com/in/johnsmith"}]}'
            }
        ...
        module.notifyListeners = notifyListeners_mock.__get__(module, sfp_rocketreach)
        ...
        self.assertIn('HUMAN_NAME', event_types)
        self.assertIn('JOB_TITLE', event_types)
        self.assertIn('COMPANY_NAME', event_types)
        self.assertIn('EMAILADDR', event_types)
        self.assertIn('SOCIAL_MEDIA', event_types)
