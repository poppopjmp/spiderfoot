# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_spamhaus.py
...
class TestModuleSpamhaus(SpiderFootModuleTestCase):
    """Test Spamhaus module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_spamhaus",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_spamhaus, module_attributes=module_attributes
        )
