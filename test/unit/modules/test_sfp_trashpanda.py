# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_trashpanda.py
...
class TestModuleTrashpanda(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_trashpanda",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_trashpanda, module_attributes=module_attributes
        )
