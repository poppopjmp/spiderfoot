# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_sublist3r.py
...
class TestModuleSublist3r(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_sublist3r",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_sublist3r, module_attributes=module_attributes
        )
