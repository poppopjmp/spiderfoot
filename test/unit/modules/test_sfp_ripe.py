# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_ripe.py
...
class TestModuleRipe(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_ripe",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_ripe, module_attributes=module_attributes
        )
