# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_whoxy.py
...
class TestModuleWhoxy(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_whoxy",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_whoxy, module_attributes=module_attributes
        )
