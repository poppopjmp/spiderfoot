# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_comodo.py
...
class TestModuleComodo(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_comodo",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_comodo, module_attributes=module_attributes
        )
