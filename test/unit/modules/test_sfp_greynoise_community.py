...
"""
Test module for sfp_greynoise_community.
This module contains unit tests for the GreynoiseCommunity SpiderFoot plugin.
"""
...
class TestModuleGreynoiseCommunity(SpiderFootTestBase):
    ...
    def setUp(self):
        ...
        super().setUp()
        # Initialize module
        self.module = sfp_greynoise_community()
