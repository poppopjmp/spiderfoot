# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_pageinfo.py
...
class TestModulePageinfo(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_pageinfo",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_pageinfo, module_attributes=module_attributes
        )
