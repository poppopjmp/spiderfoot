# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_quad9.py
...
class TestModuleQuad9(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_quad9",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_quad9, module_attributes=module_attributes
        )
