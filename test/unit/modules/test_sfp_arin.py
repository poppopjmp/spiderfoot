# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_arin.py
...
class TestModuleArin(SpiderFootModuleTestCase):
    """Test Arin module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_arin",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_arin, module_attributes=module_attributes
        )
