# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_citadel.py
...
class TestModuleCitadel(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_citadel",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_citadel, module_attributes=module_attributes
        )
