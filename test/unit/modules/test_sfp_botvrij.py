# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_botvrij.py
...
class TestModuleBotvrij(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_botvrij",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_botvrij, module_attributes=module_attributes
        )
