# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_adguard_dns.py
...
class TestModuleAdguardDns(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_adguard_dns",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_adguard_dns, module_attributes=module_attributes
        )
