# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_openstreetmap.py
...
class TestModuleOpenstreetmap(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_openstreetmap",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_openstreetmap, module_attributes=module_attributes
        )
