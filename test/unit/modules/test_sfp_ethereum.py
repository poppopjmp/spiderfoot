...
class TestModuleEthereum(SpiderFootTestBase):
    ...
    def test_handleEvent_event_data_containing_ethereum_string_should_return_event(self, depth=0):
        sf = SpiderFoot(self.default_options)
    ...
    @safe_recursion(max_depth=5)
    def test_handleEvent_event_data_not_containing_ethereum_string_should_not_return_event(self, depth=0):
        sf = SpiderFoot(self.default_options)
