# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_customfeed.py
...
class TestModuleCustomfeed(SpiderFootModuleTestCase):
    """Test Customfeed module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_customfeed",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_customfeed, module_attributes=module_attributes
        )
