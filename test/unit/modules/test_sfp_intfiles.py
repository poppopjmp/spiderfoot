# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_intfiles.py
...
class TestModuleiNtfiles(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_intfiles",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_intfiles, module_attributes=module_attributes
        )
