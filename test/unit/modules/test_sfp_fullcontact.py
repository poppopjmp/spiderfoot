# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_fullcontact.py
...
class TestModuleFullcontact(SpiderFootModuleTestCase):
    """Test Fullcontact module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_fullcontact",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_fullcontact, module_attributes=module_attributes
        )
