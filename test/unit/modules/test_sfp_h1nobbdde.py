# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_h1nobbdde.py
...
class TestModuleh1nobbdde(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_h1nobbdde",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_h1nobbdde, module_attributes=module_attributes
        )
