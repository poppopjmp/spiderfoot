...
"""
Test module for sfp_tool_trufflehog.
This module contains unit tests for the ToolTrufflehog SpiderFoot plugin.
"""
...
class TestModuleToolTrufflehog(SpiderFootTestBase):
    ...
    def setUp(self):
        ...
        super().setUp()
        # Initialize module
        self.module = sfp_tool_trufflehog()
