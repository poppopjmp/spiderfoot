...
class TestModuleEmail(SpiderFootModuleTestCase):
    ...
    def test_handleEvent_event_data_containing_emails_should_return_extracted_email_event(self):
        sf = SpiderFoot(self.default_options)
        ...
        event_data = 'Here is an email test@example.com in some text'
    ...
    def test_handleEvent_event_data_not_containing_emails_should_not_return_event(self):
        sf = SpiderFoot(self.default_options)
        ...
        event_type = 'TARGET_WEB_CONTENT'
        event_data = 'Here is some text with no emails'
        event_module = 'example module'
        source_event = evt
        evt = SpiderFootEvent(event_type, event_data, event_module, source_event)
