# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_psbdmp.py
...
class TestModulePsbdmp(SpiderFootModuleTestCase):
    """Test Psbdmp module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_psbdmp",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_psbdmp, module_attributes=module_attributes
        )
