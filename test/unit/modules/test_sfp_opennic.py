# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_opennic.py
...
class TestModuleOpennic(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_opennic",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_opennic, module_attributes=module_attributes
        )
