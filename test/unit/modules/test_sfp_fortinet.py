# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_fortinet.py
...
class TestModuleFortinet(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_fortinet",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_fortinet, module_attributes=module_attributes
        )
