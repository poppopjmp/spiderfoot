# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_builtwith.py
...
class TestModuleBuiltwith(SpiderFootModuleTestCase):
    """Test Builtwith module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_builtwith",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_builtwith, module_attributes=module_attributes
        )
