# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_iban.py
...
class TestModuleiBan(SpiderFootModuleTestCase):
    """Test I Ban module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_iban",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_iban, module_attributes=module_attributes
        )
