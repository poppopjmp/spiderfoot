# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_template.py
...
class TestModuleTemplate(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_template",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_template, module_attributes=module_attributes
        )
