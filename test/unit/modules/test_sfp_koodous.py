# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_koodous.py
...
class TestModuleKoodous(SpiderFootModuleTestCase):
    """Test Koodous module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_koodous",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_koodous, module_attributes=module_attributes
        )
