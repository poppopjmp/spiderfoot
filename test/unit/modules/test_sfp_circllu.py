# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_circllu.py
...
class TestModuleCircllu(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_circllu",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_circllu, module_attributes=module_attributes
        )
