# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_viewdns.py
...
class TestModuleViewdns(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_viewdns",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_viewdns, module_attributes=module_attributes
        )
