# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_coinblocker.py
...
class TestModuleCoinblocker(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_coinblocker",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_coinblocker, module_attributes=module_attributes
        )
