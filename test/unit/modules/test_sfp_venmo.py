# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_venmo.py
...
class TestModuleVenmo(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_venmo",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_venmo, module_attributes=module_attributes
        )
