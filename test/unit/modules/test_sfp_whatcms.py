# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_whatcms.py
...
class TestModuleWhatcms(SpiderFootModuleTestCase):
    """Test Whatcms module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_whatcms",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_whatcms, module_attributes=module_attributes
        )
