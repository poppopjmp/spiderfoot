# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_webserver.py
...
class TestModuleWebserver(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_webserver",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_webserver, module_attributes=module_attributes
        )
