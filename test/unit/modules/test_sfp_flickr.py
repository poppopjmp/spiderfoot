# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_flickr.py
...
class TestModuleFlickr(SpiderFootModuleTestCase):
    """Test Flickr module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_flickr",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_flickr, module_attributes=module_attributes
        )
