# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dronebl.py
...
class TestModuleDronebl(SpiderFootModuleTestCase):
    """Test Dronebl module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dronebl",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dronebl, module_attributes=module_attributes
        )
