# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_textmagic.py
...
class TestModuleTextmagic(SpiderFootModuleTestCase):
    """Test Textmagic module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_textmagic",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_textmagic, module_attributes=module_attributes
        )
