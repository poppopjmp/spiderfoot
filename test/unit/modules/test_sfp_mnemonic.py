# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_mnemonic.py
...
class TestModuleMnemonic(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_mnemonic",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_mnemonic, module_attributes=module_attributes
        )
