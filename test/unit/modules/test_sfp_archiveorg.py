...
"""Tests for sfp_archiveorg module."""
...
class TestModuleArchiveorg(TestModuleBase):
    ...
    def test_opts(self):
        ...
        self.assertEqual(len(module.opts), len(module.optdescs))  # opts and optdescs should always match
