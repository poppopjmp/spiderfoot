# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_archiveorg.py
...
class TestModuleArchiveorg(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_archiveorg",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_archiveorg, module_attributes=module_attributes
        )
