# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_leakix.py
...
class TestModuleLeakix(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_leakix",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_leakix, module_attributes=module_attributes
        )
