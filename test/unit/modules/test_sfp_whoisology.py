# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_whoisology.py
...
class TestModuleWhoisology(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_whoisology",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_whoisology, module_attributes=module_attributes
        )
