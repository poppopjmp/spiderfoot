# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_spyonweb.py
...
class TestModuleSpyonweb(SpiderFootModuleTestCase):
    """Test Spyonweb module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_spyonweb",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_spyonweb, module_attributes=module_attributes
        )
