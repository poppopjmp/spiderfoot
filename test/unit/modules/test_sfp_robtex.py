# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_robtex.py
...
class TestModuleRobtex(SpiderFootModuleTestCase):
    """Test Robtex module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_robtex",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_robtex, module_attributes=module_attributes
        )
