# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dnsresolve.py
...
class TestModuleDnsresolve(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dnsresolve",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dnsresolve, module_attributes=module_attributes
        )
