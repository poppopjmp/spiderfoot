# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dnsbrute.py
...
class TestModuleDnsbrute(SpiderFootModuleTestCase):
    """Test Dnsbrute module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dnsbrute",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dnsbrute, module_attributes=module_attributes
        )
