# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_phone.py
...
class TestModulePhone(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_phone",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_phone, module_attributes=module_attributes
        )
