# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_sociallinks.py
...
class TestModuleSociallinks(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_sociallinks",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_sociallinks, module_attributes=module_attributes
        )
