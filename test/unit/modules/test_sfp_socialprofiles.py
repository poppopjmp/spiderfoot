# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_socialprofiles.py
...
class TestModuleSocialprofiles(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_socialprofiles",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_socialprofiles, module_attributes=module_attributes
        )
