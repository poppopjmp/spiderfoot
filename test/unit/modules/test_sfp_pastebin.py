# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_pastebin.py
...
class TestModulePastebin(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_pastebin",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_pastebin, module_attributes=module_attributes
        )
