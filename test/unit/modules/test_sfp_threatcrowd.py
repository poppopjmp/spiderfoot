# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_threatcrowd.py
...
class TestModuleThreatcrowd(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_threatcrowd",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_threatcrowd, module_attributes=module_attributes
        )
