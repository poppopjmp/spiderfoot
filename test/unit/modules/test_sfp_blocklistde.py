# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_blocklistde.py
...
class TestModuleBlocklistde(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_blocklistde",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_blocklistde, module_attributes=module_attributes
        )
