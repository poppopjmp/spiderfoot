# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_crobat_api.py
...
class TestModuleCrobatApi(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_crobat_api",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_crobat_api, module_attributes=module_attributes
        )
