# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_google_tag_manager.py
...
class TestModuleGoogleTagManager(SpiderFootModuleTestCase):
    """Test Google Tag Manager module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_google_tag_manager",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_google_tag_manager, module_attributes=module_attributes
        )
