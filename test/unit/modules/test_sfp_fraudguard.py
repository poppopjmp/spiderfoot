# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_fraudguard.py
...
class TestModuleFraudguard(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_fraudguard",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_fraudguard, module_attributes=module_attributes
        )
