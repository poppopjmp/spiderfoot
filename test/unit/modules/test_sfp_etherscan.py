# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_etherscan.py
...
class TestModuleEtherscan(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_etherscan",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_etherscan, module_attributes=module_attributes
        )
