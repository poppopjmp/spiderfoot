# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_grep_app.py
...
class TestModuleGrepApp(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_grep_app",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_grep_app, module_attributes=module_attributes
        )
