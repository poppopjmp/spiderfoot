# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_googlesafebrowsing.py
...
class TestModuleGooglesafebrowsing(SpiderFootModuleTestCase):
    """Test Googlesafebrowsing module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_googlesafebrowsing",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_googlesafebrowsing, module_attributes=module_attributes
        )
