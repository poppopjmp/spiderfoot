# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_snov.py
...
class TestModuleSnov(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_snov",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_snov, module_attributes=module_attributes
        )
