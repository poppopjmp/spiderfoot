# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dnsdumpster.py
...
class TestModuleDnsdumpster(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dnsdumpster",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dnsdumpster, module_attributes=module_attributes
        )
