# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_hostio.py
...
class TestModulehOstio(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_hostio",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_hostio, module_attributes=module_attributes
        )
