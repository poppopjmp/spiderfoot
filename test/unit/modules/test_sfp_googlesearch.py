# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_googlesearch.py
...
class TestModuleGooglesearch(SpiderFootModuleTestCase):
    """Test Googlesearch module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_googlesearch",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_googlesearch, module_attributes=module_attributes
        )
