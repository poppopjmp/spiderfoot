# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_talosintel.py
...
class TestModuleTalosintel(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_talosintel",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_talosintel, module_attributes=module_attributes
        )
