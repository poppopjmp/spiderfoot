# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_virustotal.py
...
class TestModuleVirustotal(SpiderFootModuleTestCase):
    """Test Virustotal module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_virustotal",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_virustotal, module_attributes=module_attributes
        )
