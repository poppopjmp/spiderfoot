# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_googleobjectstorage.py
...
class TestModuleGoogleobjectstorage(SpiderFootModuleTestCase):
    """Test Googleobjectstorage module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_googleobjectstorage",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_googleobjectstorage, module_attributes=module_attributes
        )
