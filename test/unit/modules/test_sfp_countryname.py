# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_countryname.py
...
class TestModuleCountryname(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_countryname",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_countryname, module_attributes=module_attributes
        )
