# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_cleanbrowsing.py
...
class TestModuleCleanbrowsing(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_cleanbrowsing",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_cleanbrowsing, module_attributes=module_attributes
        )
