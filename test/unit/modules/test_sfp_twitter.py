# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_twitter.py
...
class TestModuleTwitter(SpiderFootModuleTestCase):
    """Test Twitter module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_twitter",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_twitter, module_attributes=module_attributes
        )
