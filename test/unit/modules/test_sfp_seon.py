# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_seon.py
...
class TestModuleSeon(SpiderFootModuleTestCase):
    """Test Seon module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_seon",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_seon, module_attributes=module_attributes
        )
