# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_keybase.py
...
class TestModuleKeybase(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_keybase",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_keybase, module_attributes=module_attributes
        )
