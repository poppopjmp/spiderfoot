# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_adblock.py
...
class TestModuleAdblock(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_adblock",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_adblock, module_attributes=module_attributes
        )
