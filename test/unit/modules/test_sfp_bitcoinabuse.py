# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_bitcoinabuse.py
...
class TestModuleBitcoinabuse(SpiderFootModuleTestCase):
    """Test Bitcoinabuse module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_bitcoinabuse",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_bitcoinabuse, module_attributes=module_attributes
        )
