# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_spur.py
...
class TestModuleSpur(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_spur",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_spur, module_attributes=module_attributes
        )
