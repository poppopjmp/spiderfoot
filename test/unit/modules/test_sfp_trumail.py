# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_trumail.py
...
class TestModuleTrumail(SpiderFootModuleTestCase):
    """Test Trumail module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_trumail",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_trumail, module_attributes=module_attributes
        )
