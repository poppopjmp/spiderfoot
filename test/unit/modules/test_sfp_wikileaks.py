# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_wikileaks.py
...
class TestModuleWikileaks(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_wikileaks",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_wikileaks, module_attributes=module_attributes
        )
