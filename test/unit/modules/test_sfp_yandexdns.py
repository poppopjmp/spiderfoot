# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_yandexdns.py
...
class TestModuleYandexdns(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_yandexdns",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_yandexdns, module_attributes=module_attributes
        )
