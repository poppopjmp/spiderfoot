# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dnsgrep.py
...
class TestModuleDnsgrep(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dnsgrep",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dnsgrep, module_attributes=module_attributes
        )
