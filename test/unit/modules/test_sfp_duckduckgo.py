# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_duckduckgo.py
...
class TestModuleDuckduckgo(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_duckduckgo",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_duckduckgo, module_attributes=module_attributes
        )
