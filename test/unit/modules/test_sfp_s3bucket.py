# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_s3bucket.py
...
class TestModuleS3bucket(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_s3bucket",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_s3bucket, module_attributes=module_attributes
        )
