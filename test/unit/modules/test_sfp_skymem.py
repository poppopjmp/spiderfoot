# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_skymem.py
...
class TestModuleSkymem(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_skymem",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_skymem, module_attributes=module_attributes
        )
