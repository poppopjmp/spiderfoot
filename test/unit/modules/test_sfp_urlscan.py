# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_urlscan.py
...
class TestModuleUrlscan(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_urlscan",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_urlscan, module_attributes=module_attributes
        )
