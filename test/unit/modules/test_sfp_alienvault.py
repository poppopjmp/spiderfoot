# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_alienvault.py
...
class TestModuleAlienvault(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_alienvault",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_alienvault, module_attributes=module_attributes
        )
