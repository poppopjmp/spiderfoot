# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_xforce.py
...
class TestModulexForce(SpiderFootModuleTestCase):
    """Test X Force module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_xforce",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_xforce, module_attributes=module_attributes
        )
