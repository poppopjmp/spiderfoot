# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_cybercrimetracker.py
...
class TestModuleCybercrimetracker(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_cybercrimetracker",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_cybercrimetracker, module_attributes=module_attributes
        )
