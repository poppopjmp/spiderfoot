# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_darksearch.py
...
class TestModuleDarksearch(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_darksearch",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_darksearch, module_attributes=module_attributes
        )
