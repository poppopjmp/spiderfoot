# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_openbugbounty.py
...
class TestModuleOpenbugbounty(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_openbugbounty",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_openbugbounty, module_attributes=module_attributes
        )
