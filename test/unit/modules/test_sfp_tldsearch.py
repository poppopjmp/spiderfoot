# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_tldsearch.py
...
class TestModuleTldsearch(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_tldsearch",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_tldsearch, module_attributes=module_attributes
        )
