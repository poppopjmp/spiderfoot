# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_ipapico.py
...
class TestModuleiPapico(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_ipapico",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_ipapico, module_attributes=module_attributes
        )
