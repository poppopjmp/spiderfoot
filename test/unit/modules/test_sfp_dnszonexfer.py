# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dnszonexfer.py
...
class TestModuleDnszonexfer(SpiderFootModuleTestCase):
    """Test Dnszonexfer module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dnszonexfer",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dnszonexfer, module_attributes=module_attributes
        )
