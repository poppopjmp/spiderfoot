...
class TestModuleCookie(SpiderFootTestBase):
    ...
    def test_handleEvent_event_data_containing_cookie_should_return_event(self, depth=0):
        sf = SpiderFoot(self.default_options)
    ...
    @safe_recursion(max_depth=5)
    def test_handleEvent_event_data_not_containing_cookie_should_not_return_event(self, depth=0):
        sf = SpiderFoot(self.default_options)
