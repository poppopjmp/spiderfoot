# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_webanalytics.py
...
class TestModuleWebanalytics(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_webanalytics",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_webanalytics, module_attributes=module_attributes
        )
