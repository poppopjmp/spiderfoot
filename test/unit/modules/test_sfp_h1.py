# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_h1.py
...
class TestModuleh1(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_h1",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_h1, module_attributes=module_attributes
        )
