# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_projectdiscovery.py
...
class TestModuleProjectdiscovery(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_projectdiscovery",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_projectdiscovery, module_attributes=module_attributes
        )
