# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_abstractapi.py
...
class TestModuleAbstractapi(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_abstractapi",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_abstractapi, module_attributes=module_attributes
        )
