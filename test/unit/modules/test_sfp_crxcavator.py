# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_crxcavator.py
...
class TestModuleCrxcavator(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_crxcavator",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_crxcavator, module_attributes=module_attributes
        )
