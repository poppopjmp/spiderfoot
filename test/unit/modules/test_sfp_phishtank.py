# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_phishtank.py
...
class TestModulePhishtank(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_phishtank",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_phishtank, module_attributes=module_attributes
        )
