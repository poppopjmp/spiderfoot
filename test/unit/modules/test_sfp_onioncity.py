# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_onioncity.py
...
class TestModuleOnioncity(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_onioncity",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_onioncity, module_attributes=module_attributes
        )
