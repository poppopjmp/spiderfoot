# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_spider.py
...
class TestModuleSpider(SpiderFootModuleTestCase):
    """Test Spider module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_spider",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_spider, module_attributes=module_attributes
        )
