# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_networksdb.py
...
class TestModuleNetworksdb(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_networksdb",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_networksdb, module_attributes=module_attributes
        )
