# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_binstring.py
...
class TestModuleBinstring(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_binstring",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_binstring, module_attributes=module_attributes
        )
