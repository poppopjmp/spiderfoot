# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_neutrinoapi.py
...
class TestModuleNeutrinoapi(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_neutrinoapi",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_neutrinoapi, module_attributes=module_attributes
        )
