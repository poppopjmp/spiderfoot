# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_fullhunt.py
...
class TestModuleFullhunt(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_fullhunt",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_fullhunt, module_attributes=module_attributes
        )
