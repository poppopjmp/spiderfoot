...
"""
Test module for sfp_emailcrawlr.
This module contains unit tests for the Emailcrawlr SpiderFoot plugin.
"""
...
class TestModuleEmailcrawlr(SpiderFootTestBase):
