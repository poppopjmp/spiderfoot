# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_reversewhois.py
...
class TestModuleReversewhois(SpiderFootModuleTestCase):
    """Test Reversewhois module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_reversewhois",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_reversewhois, module_attributes=module_attributes
        )
