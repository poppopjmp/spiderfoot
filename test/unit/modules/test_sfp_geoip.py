# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_geoip.py
...
class TestModuleGeoip(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_geoip",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_geoip, module_attributes=module_attributes
        )
