# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_creditcard.py
...
class TestModuleCreditcard(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_creditcard",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_creditcard, module_attributes=module_attributes
        )
