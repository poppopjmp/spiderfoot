# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dnssublist.py
...
class TestModuleDnssublist(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dnssublist",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dnssublist, module_attributes=module_attributes
        )
