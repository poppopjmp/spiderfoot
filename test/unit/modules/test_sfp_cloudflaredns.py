# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_cloudflaredns.py
...
class TestModuleCloudflaredns(SpiderFootModuleTestCase):
    """Test Cloudflaredns module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_cloudflaredns",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_cloudflaredns, module_attributes=module_attributes
        )
