# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_ipapicom.py
...
class TestModuleiPapicom(SpiderFootModuleTestCase):
    """Test I Papicom module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_ipapicom",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_ipapicom, module_attributes=module_attributes
        )
