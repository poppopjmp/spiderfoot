# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_c99.py
...
class TestModuleC99(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_c99",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_c99, module_attributes=module_attributes
        )
