# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_bitcoinwhoswho.py
...
class TestModuleBitcoinwhoswho(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_bitcoinwhoswho",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_bitcoinwhoswho, module_attributes=module_attributes
        )
