# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_hunter.py
...
class TestModulehUnter(SpiderFootModuleTestCase):
    """Test H Unter module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_hunter",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_hunter, module_attributes=module_attributes
        )
