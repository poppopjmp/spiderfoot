# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_greensnow.py
...
class TestModuleGreensnow(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_greensnow",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_greensnow, module_attributes=module_attributes
        )
