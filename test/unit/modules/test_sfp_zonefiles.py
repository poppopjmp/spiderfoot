...
"""
Test module for sfp_zonefiles.
This module contains unit tests for the Zonefiles SpiderFoot plugin.
"""
...
class TestModuleZoneFiles(SpiderFootTestBase):
