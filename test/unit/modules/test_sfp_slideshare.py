# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_slideshare.py
...
class TestModuleSlideshare(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_slideshare",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_slideshare, module_attributes=module_attributes
        )
