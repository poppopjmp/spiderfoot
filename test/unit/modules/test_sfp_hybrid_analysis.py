...
"""
Test module for sfp_hybrid_analysis.
This module contains unit tests for the HybridAnalysis SpiderFoot plugin.
"""
...
class TestModuleHybridAnalysis(SpiderFootTestBase):
    ...
    def setUp(self):
        ...
        super().setUp()
        # Initialize module
        self.module = sfp_hybrid_analysis()
