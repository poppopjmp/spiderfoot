# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_pulsedive.py
...
class TestModulePulsedive(SpiderFootModuleTestCase):
    """Test Pulsedive module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_pulsedive",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_pulsedive, module_attributes=module_attributes
        )
