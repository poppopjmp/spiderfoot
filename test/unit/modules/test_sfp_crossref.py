# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_crossref.py
...
class TestModuleCrossref(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_crossref",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_crossref, module_attributes=module_attributes
        )
