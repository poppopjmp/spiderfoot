# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_hibp.py
...
class TestModulehIbp(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_hibp",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_hibp, module_attributes=module_attributes
        )
