# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_opencorporates.py
...
class TestModuleOpencorporates(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_opencorporates",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_opencorporates, module_attributes=module_attributes
        )
