# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_debounce.py
...
class TestModuleDebounce(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_debounce",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_debounce, module_attributes=module_attributes
        )
