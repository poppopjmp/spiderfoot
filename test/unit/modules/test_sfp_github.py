# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_github.py
...
class TestModuleGithub(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_github",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_github, module_attributes=module_attributes
        )
