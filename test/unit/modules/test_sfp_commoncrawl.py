# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_commoncrawl.py
...
class TestModuleCommoncrawl(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_commoncrawl",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_commoncrawl, module_attributes=module_attributes
        )
