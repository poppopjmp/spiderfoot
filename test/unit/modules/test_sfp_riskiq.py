# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_riskiq.py
...
class TestModuleRiskiq(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_riskiq",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_riskiq, module_attributes=module_attributes
        )
