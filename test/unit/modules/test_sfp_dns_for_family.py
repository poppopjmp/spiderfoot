# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_dns_for_family.py
...
class TestModuleDnsForFamily(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_dns_for_family",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_dns_for_family, module_attributes=module_attributes
        )
