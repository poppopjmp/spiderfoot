# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_myspace.py
...
class TestModuleMyspace(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_myspace",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_myspace, module_attributes=module_attributes
        )
