# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_binaryedge.py
...
class TestModuleBinaryedge(SpiderFootModuleTestCase):
    """Test Binaryedge module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_binaryedge",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_binaryedge, module_attributes=module_attributes
        )
