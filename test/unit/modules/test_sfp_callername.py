# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_callername.py
...
class TestModuleCallername(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_callername",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_callername, module_attributes=module_attributes
        )
