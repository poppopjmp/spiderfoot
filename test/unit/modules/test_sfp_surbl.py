# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_surbl.py
...
class TestModuleSurbl(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_surbl",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_surbl, module_attributes=module_attributes
        )
