# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_multiproxy.py
...
class TestModuleMultiproxy(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_multiproxy",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_multiproxy, module_attributes=module_attributes
        )
