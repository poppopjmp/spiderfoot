...
class TestPhoneInfogaModuleUnit(TestModuleBase):
    def setUp(self):
        ...
        self.module.opts['remote_enabled'] = False
    ...
    def test_handleEvent_remote_execution(self, mock_sshclient):
        # Setup mock SSH client and output
        mock_ssh = MagicMock()
