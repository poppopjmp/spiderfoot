# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_isc.py
...
class TestModuleiSc(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_isc",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_isc, module_attributes=module_attributes
        )
