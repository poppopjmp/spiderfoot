# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_cleantalk.py
...
class TestModuleCleantalk(SpiderFootModuleTestCase):
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_cleantalk",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_cleantalk, module_attributes=module_attributes
        )
