# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_torch.py
...
class TestModuleTorch(SpiderFootModuleTestCase):
    """Test Torch module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_torch",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_torch, module_attributes=module_attributes
        )
