# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/unit/modules/test_sfp_ipregistry.py
...
class TestModuleiPregistry(SpiderFootModuleTestCase):
    """Test I Pregistry module."""
    ...
    def setUp(self):
        ...
        module_attributes = {
            "descr": "Description for sfp_ipregistry",
            # Add module-specific options
        }

        self.module_class = self.create_module_wrapper(
            sfp_ipregistry, module_attributes=module_attributes
        )
