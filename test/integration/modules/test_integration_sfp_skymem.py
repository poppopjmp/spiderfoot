# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_skymem.py
import pytest
...
# This test requires credentials for the Skymem service
# To run this test, set the environment variables:
# - SF_SFP_SKYMEM_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_SKYMEM_API_KEY']),
    reason="Integration test - requires Skymem credentials"
)
class TestModuleIntegrationSkymem:
    """Integration testing for the Skymem module."""

    @pytest.fixture
    def module(self):
        """Return a Skymem module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
