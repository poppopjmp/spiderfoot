# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_fringeproject.py
import pytest
...
# This test requires credentials for the Fringeproject service
# To run this test, set the environment variables:
# - SF_SFP_FRINGEPROJECT_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_FRINGEPROJECT_API_KEY']),
    reason="Integration test - requires Fringeproject credentials"
)
class TestModuleIntegrationFringeproject:
    """Integration testing for the Fringeproject module."""

    @pytest.fixture
    def module(self):
        """Return a Fringeproject module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
