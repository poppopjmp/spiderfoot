# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_duckduckgo.py
import pytest
...
# This test requires credentials for the Duckduckgo service
# To run this test, set the environment variables:
# - SF_SFP_DUCKDUCKGO_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_DUCKDUCKGO_API_KEY']),
    reason="Integration test - requires Duckduckgo credentials"
)
class TestModuleIntegrationDuckduckgo:
    """Integration testing for the Duckduckgo module."""

    @pytest.fixture
    def module(self):
        """Return a Duckduckgo module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
