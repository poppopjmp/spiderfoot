# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_onioncity.py
import pytest
...
# This test requires credentials for the Onioncity service
# To run this test, set the environment variables:
# - SF_SFP_ONIONCITY_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_ONIONCITY_API_KEY']),
    reason="Integration test - requires Onioncity credentials"
)
class TestModuleIntegrationOnioncity:
    """Integration testing for the Onioncity module."""

    @pytest.fixture
    def module(self):
        """Return a Onioncity module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
