# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_zoomeye.py
import pytest
...
# This test requires credentials for the Zoomeye service
# To run this test, set the environment variables:
# - SF_SFP_ZOOMEYE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_ZOOMEYE_API_KEY']),
    reason="Integration test - requires Zoomeye credentials"
)
class TestModuleIntegrationZoomeye:
    """Integration testing for the Zoomeye module."""

    @pytest.fixture
    def module(self):
        """Return a Zoomeye module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
