...
"""Tests for sfp_alienvault module."""
...
class TestModuleIntegrationalienvault(TestModuleBase):
    ...
    def test_handleEvent(self):
        ...
        module.__name__ = "sfp_alienvault"
        ...
        with mock_mod.patch.object(sf, 'fetchUrl', return_value={'code': '200', 'content': '{"pulse_info": {"pulses": []}}'}):
