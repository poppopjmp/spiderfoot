# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_github.py
import pytest
...
# This test requires credentials for the Github service
# To run this test, set the environment variables:
# - SF_SFP_GITHUB_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_GITHUB_API_KEY']),
    reason="Integration test - requires Github credentials"
)
class TestModuleIntegrationGithub:
    """Integration testing for the Github module."""

    @pytest.fixture
    def module(self):
        """Return a Github module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
