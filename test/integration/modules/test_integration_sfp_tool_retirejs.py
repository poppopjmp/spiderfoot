# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_tool_retirejs.py
import pytest
...
# This test requires credentials for the Tool Retirejs service
# To run this test, set the environment variables:
# - SF_SFP_TOOL_RETIREJS_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TOOL_RETIREJS_API_KEY']),
    reason="Integration test - requires Tool Retirejs credentials"
)
class TestModuleIntegrationToolRetirejs:
    """Integration testing for the Tool Retirejs module."""

    @pytest.fixture
    def module(self):
        """Return a Tool Retirejs module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
