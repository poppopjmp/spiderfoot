# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_myspace.py
import pytest
...
# This test requires credentials for the Myspace service
# To run this test, set the environment variables:
# - SF_SFP_MYSPACE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_MYSPACE_API_KEY']),
    reason="Integration test - requires Myspace credentials"
)
class TestModuleIntegrationMyspace:
    """Integration testing for the Myspace module."""

    @pytest.fixture
    def module(self):
        """Return a Myspace module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
