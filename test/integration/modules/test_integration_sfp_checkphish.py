# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_checkphish.py
import pytest
...
from modules.sfp_checkphish import sfp_checkphish

# This test requires credentials for the Checkphish service
# To run this test, set the environment variables:
# - SF_SFP_CHECKPHISH_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_CHECKPHISH_API_KEY']),
    reason="Integration test - requires Checkphish credentials"
)
class TestModuleIntegrationCheckphish:
    """Integration testing for the Checkphish module."""

    @pytest.fixture
    def module(self):
        """Return a Checkphish module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
