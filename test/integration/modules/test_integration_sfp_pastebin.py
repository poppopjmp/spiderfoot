# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_pastebin.py
import pytest
...
# This test requires credentials for the Pastebin service
# To run this test, set the environment variables:
# - SF_SFP_PASTEBIN_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_PASTEBIN_API_KEY']),
    reason="Integration test - requires Pastebin credentials"
)
class TestModuleIntegrationPastebin:
    """Integration testing for the Pastebin module."""

    @pytest.fixture
    def module(self):
        """Return a Pastebin module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
