# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_comodo.py
import pytest
import os
...
# This test requires credentials for the Comodo service
# To run this test, set the environment variables:
# - SF_SFP_COMODO_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ["SF_SFP_COMODO_API_KEY"]),
    reason="Integration test - requires Comodo credentials",
)
class TestModuleIntegrationComodo:
    """Integration testing for the Comodo module."""

    @pytest.fixture
    def module(self):
        """Return a Comodo module."""
        sf = SpiderFoot(
            {
                "_debug": True,
                "__logging": True,
