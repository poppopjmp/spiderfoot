# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_quad9.py
import pytest
...
# This test requires credentials for the Quad9 service
# To run this test, set the environment variables:
# - SF_SFP_QUAD9_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_QUAD9_API_KEY']),
    reason="Integration test - requires Quad9 credentials"
)
class TestModuleIntegrationQuad9:
    """Integration testing for the Quad9 module."""

    @pytest.fixture
    def module(self):
        """Return a Quad9 module."""
        sf = SpiderFoot({
            '_debug': True,
            '__logging': True,
            '__outputfilter': None,
