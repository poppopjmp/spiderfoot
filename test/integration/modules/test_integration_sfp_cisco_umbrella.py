# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_cisco_umbrella.py
import pytest
...
# This test requires credentials for the Cisco Umbrella service
# To run this test, set the environment variables:
# - SF_SFP_CISCO_UMBRELLA_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_CISCO_UMBRELLA_API_KEY']),
    reason="Integration test - requires Cisco Umbrella credentials"
)
class TestModuleIntegrationCiscoUmbrella:
    """Integration testing for the Cisco Umbrella module."""

    @pytest.fixture
    def module(self):
        """Return a Cisco Umbrella module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
