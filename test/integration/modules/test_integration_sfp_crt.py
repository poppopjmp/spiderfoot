# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_crt.py
import pytest
...
# This test requires credentials for the Crt service
# To run this test, set the environment variables:
# - SF_SFP_CRT_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_CRT_API_KEY']),
    reason="Integration test - requires Crt credentials"
)
class TestModuleIntegrationCrt:
    """Integration testing for the Crt module."""
