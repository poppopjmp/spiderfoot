# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_maltiverse.py
import pytest
...
# This test requires credentials for the Maltiverse service
# To run this test, set the environment variables:
# - SF_SFP_MALTIVERSE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_MALTIVERSE_API_KEY']),
    reason="Integration test - requires Maltiverse credentials"
)
class TestModuleIntegrationMaltiverse:
    """Integration testing for the Maltiverse module."""

    @pytest.fixture
    def module(self):
        """Return a Maltiverse module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
