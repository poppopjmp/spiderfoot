# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_greensnow.py
import pytest
...
# This test requires credentials for the Greensnow service
# To run this test, set the environment variables:
# - SF_SFP_GREENSNOW_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_GREENSNOW_API_KEY']),
    reason="Integration test - requires Greensnow credentials"
)
class TestModuleIntegrationGreensnow:
    """Integration testing for the Greensnow module."""

    @pytest.fixture
    def module(self):
        """Return a Greensnow module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
