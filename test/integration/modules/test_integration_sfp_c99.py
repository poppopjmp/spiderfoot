# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_c99.py
import pytest
...
# This test requires credentials for the C99 service
# To run this test, set the environment variables:
# - SF_SFP_C99_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_C99_API_KEY']),
    reason="Integration test - requires C99 credentials"
)
class TestModuleIntegrationC99:
    """Integration testing for the C99 module."""
