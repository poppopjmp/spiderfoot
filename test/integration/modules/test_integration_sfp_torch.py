# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_torch.py
import pytest
...
# This test requires credentials for the Torch service
# To run this test, set the environment variables:
# - SF_SFP_TORCH_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TORCH_API_KEY']),
    reason="Integration test - requires Torch credentials"
)
class TestModuleIntegrationTorch:
    """Integration testing for the Torch module."""
