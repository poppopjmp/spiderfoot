# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_h1nobbdde.py
import pytest
...
# This test requires credentials for the H1nobbdde service
# To run this test, set the environment variables:
# - SF_SFP_H1NOBBDDE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_H1NOBBDDE_API_KEY']),
    reason="Integration test - requires H1nobbdde credentials"
)
class TestModuleIntegrationh1nobbdde:
    """Integration testing for the H1nobbdde module."""

    @pytest.fixture
    def module(self):
        """Return a H1nobbdde module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
