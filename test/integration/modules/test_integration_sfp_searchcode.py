# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_searchcode.py
import pytest
...
# This test requires credentials for the Searchcode service
# To run this test, set the environment variables:
# - SF_SFP_SEARCHCODE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_SEARCHCODE_API_KEY']),
    reason="Integration test - requires Searchcode credentials"
)
class TestModuleIntegrationSearchcode:
    """Integration testing for the Searchcode module."""

    @pytest.fixture
    def module(self):
        """Return a Searchcode module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
