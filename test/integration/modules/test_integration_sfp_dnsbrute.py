# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_dnsbrute.py
import pytest
...
# This test requires credentials for the Dnsbrute service
# To run this test, set the environment variables:
# - SF_SFP_DNSBRUTE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_DNSBRUTE_API_KEY']),
    reason="Integration test - requires Dnsbrute credentials"
)
class TestModuleIntegrationDnsbrute:
    """Integration testing for the Dnsbrute module."""

    @pytest.fixture
    def module(self):
        """Return a Dnsbrute module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
