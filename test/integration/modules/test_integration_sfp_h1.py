# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_h1.py
import pytest
import os
...
# This test requires credentials for the H1 service
# To run this test, set the environment variables:
# - SF_SFP_H1_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ["SF_SFP_H1_API_KEY"]),
    reason="Integration test - requires H1 credentials",
)
class TestModuleIntegrationh1:
    """Integration testing for the H1 module."""
