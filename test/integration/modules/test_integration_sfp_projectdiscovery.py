# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_projectdiscovery.py
import pytest
...
# This test requires credentials for the Projectdiscovery service
# To run this test, set the environment variables:
# - SF_SFP_PROJECTDISCOVERY_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_PROJECTDISCOVERY_API_KEY']),
    reason="Integration test - requires Projectdiscovery credentials"
)
class TestModuleIntegrationProjectdiscovery:
    """Integration testing for the Projectdiscovery module."""

    @pytest.fixture
    def module(self):
        """Return a Projectdiscovery module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
