# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_openbugbounty.py
import pytest
...
# This test requires credentials for the Openbugbounty service
# To run this test, set the environment variables:
# - SF_SFP_OPENBUGBOUNTY_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_OPENBUGBOUNTY_API_KEY']),
    reason="Integration test - requires Openbugbounty credentials"
)
class TestModuleIntegrationOpenbugbounty:
    """Integration testing for the Openbugbounty module."""

    @pytest.fixture
    def module(self):
        """Return a Openbugbounty module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
