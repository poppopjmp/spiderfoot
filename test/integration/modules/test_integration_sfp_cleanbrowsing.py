# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_cleanbrowsing.py
import pytest
...
# This test requires credentials for the Cleanbrowsing service
# To run this test, set the environment variables:
# - SF_SFP_CLEANBROWSING_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_CLEANBROWSING_API_KEY']),
    reason="Integration test - requires Cleanbrowsing credentials"
)
class TestModuleIntegrationCleanbrowsing:
    """Integration testing for the Cleanbrowsing module."""

    @pytest.fixture
    def module(self):
        """Return a Cleanbrowsing module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
