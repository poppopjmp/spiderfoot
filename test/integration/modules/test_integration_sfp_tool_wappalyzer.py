# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_tool_wappalyzer.py
import pytest
...
# This test requires credentials for the Tool Wappalyzer service
# To run this test, set the environment variables:
# - SF_SFP_TOOL_WAPPALYZER_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TOOL_WAPPALYZER_API_KEY']),
    reason="Integration test - requires Tool Wappalyzer credentials"
)
class TestModuleIntegrationToolWappalyzer:
    """Integration testing for the Tool Wappalyzer module."""

    @pytest.fixture
    def module(self):
        """Return a Tool Wappalyzer module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
