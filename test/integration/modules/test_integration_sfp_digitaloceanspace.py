# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_digitaloceanspace.py
import pytest
...
# This test requires credentials for the Digitaloceanspace service
# To run this test, set the environment variables:
# - SF_SFP_DIGITALOCEANSPACE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_DIGITALOCEANSPACE_API_KEY']),
    reason="Integration test - requires Digitaloceanspace credentials"
)
class TestModuleIntegrationDigitaloceanspace:
    """Integration testing for the Digitaloceanspace module."""

    @pytest.fixture
    def module(self):
        """Return a Digitaloceanspace module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
