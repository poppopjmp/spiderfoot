# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_dnsneighbor.py
import pytest
...
# This test requires credentials for the Dnsneighbor service
# To run this test, set the environment variables:
# - SF_SFP_DNSNEIGHBOR_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_DNSNEIGHBOR_API_KEY']),
    reason="Integration test - requires Dnsneighbor credentials"
)
class TestModuleIntegrationDnsneighbor:
    """Integration testing for the Dnsneighbor module."""

    @pytest.fixture
    def module(self):
        """Return a Dnsneighbor module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
