# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_cloudfront.py
import pytest
...
@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_CLOUDFRONT_API_KEY']),
