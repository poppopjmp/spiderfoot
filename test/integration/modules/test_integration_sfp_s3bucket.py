# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_s3bucket.py
import pytest
...
# This test requires credentials for the S3bucket service
# To run this test, set the environment variables:
# - SF_SFP_S3BUCKET_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_S3BUCKET_API_KEY']),
    reason="Integration test - requires S3bucket credentials"
)
class TestModuleIntegrationS3bucket:
    """Integration testing for the S3bucket module."""

    @pytest.fixture
    def module(self):
        """Return a S3bucket module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
