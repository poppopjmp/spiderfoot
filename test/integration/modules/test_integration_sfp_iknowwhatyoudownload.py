# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_iknowwhatyoudownload.py
import pytest
import os
...
# This test requires credentials for the I Knowwhatyoudownload service
...
@pytest.mark.skipif(
    not all(
        os.environ.get(env_var) for env_var in ["SF_SFP_IKNOWWHATYOUDOWNLOAD_API_KEY"]
    ),
    reason="Integration test - requires I Knowwhatyoudownload credentials",
)
class TestModuleIntegrationiKnowwhatyoudownload:
    """Integration testing for the I Knowwhatyoudownload module."""
