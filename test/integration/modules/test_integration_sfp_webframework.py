# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_webframework.py
import pytest
...
# This test requires credentials for the Webframework service
# To run this test, set the environment variables:
# - SF_SFP_WEBFRAMEWORK_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_WEBFRAMEWORK_API_KEY']),
    reason="Integration test - requires Webframework credentials"
)
class TestModuleIntegrationWebframework:
    """Integration testing for the Webframework module."""

    @pytest.fixture
    def module(self):
        """Return a Webframework module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
