# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_spyonweb.py
import pytest
...
# This test requires credentials for the Spyonweb service
# To run this test, set the environment variables:
# - SF_SFP_SPYONWEB_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_SPYONWEB_API_KEY']),
    reason="Integration test - requires Spyonweb credentials"
)
class TestModuleIntegrationSpyonweb:
    """Integration testing for the Spyonweb module."""

    @pytest.fixture
    def module(self):
        """Return a Spyonweb module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
