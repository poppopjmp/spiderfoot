# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_subdomain_takeover.py
import pytest
...
# This test requires credentials for the Subdomain Takeover service
# To run this test, set the environment variables:
# - SF_SFP_SUBDOMAIN_TAKEOVER_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_SUBDOMAIN_TAKEOVER_API_KEY']),
    reason="Integration test - requires Subdomain Takeover credentials"
)
class TestModuleIntegrationSubdomainTakeover:
    """Integration testing for the Subdomain Takeover module."""

    @pytest.fixture
    def module(self):
        """Return a Subdomain Takeover module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
