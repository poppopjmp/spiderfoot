# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_cinsscore.py
import pytest
...
# This test requires credentials for the Cinsscore service
# To run this test, set the environment variables:
# - SF_SFP_CINSSCORE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_CINSSCORE_API_KEY']),
    reason="Integration test - requires Cinsscore credentials"
)
class TestModuleIntegrationCinsscore:
    """Integration testing for the Cinsscore module."""

    @pytest.fixture
    def module(self):
        """Return a Cinsscore module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
