# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_botvrij.py
import pytest
import os
...
# This test requires credentials for the Botvrij service
# To run this test, set the environment variables:
# - SF_SFP_BOTVRIJ_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ["SF_SFP_BOTVRIJ_API_KEY"]),
    reason="Integration test - requires Botvrij credentials",
)
class TestModuleIntegrationBotvrij:
    """Integration testing for the Botvrij module."""

    @pytest.fixture
    def module(self):
        """Return a Botvrij module."""
        sf = SpiderFoot(
            {
                "_debug": True,
                "__logging": True,
