# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_social.py
import pytest
...
# This test requires credentials for the Social service
# To run this test, set the environment variables:
# - SF_SFP_SOCIAL_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_SOCIAL_API_KEY']),
    reason="Integration test - requires Social credentials"
)
class TestModuleIntegrationSocial:
    """Integration testing for the Social module."""

    @pytest.fixture
    def module(self):
        """Return a Social module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
