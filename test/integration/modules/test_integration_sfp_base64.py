# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_base64.py
import pytest
...
# This test requires credentials for the Base64 service
# To run this test, set the environment variables:
# - SF_SFP_BASE64_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_BASE64_API_KEY']),
    reason="Integration test - requires Base64 credentials"
)
class TestModuleIntegrationBase64:
    """Integration testing for the Base64 module."""

    @pytest.fixture
    def module(self):
        """Return a Base64 module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
