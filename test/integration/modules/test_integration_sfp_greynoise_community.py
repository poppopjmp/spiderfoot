# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_greynoise_community.py
import pytest
...
# This test requires credentials for the Greynoise Community service
# To run this test, set the environment variables:
# - SF_SFP_GREYNOISE_COMMUNITY_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_GREYNOISE_COMMUNITY_API_KEY']),
    reason="Integration test - requires Greynoise Community credentials"
)
class TestModuleIntegrationGreynoiseCommunity:
    """Integration testing for the Greynoise Community module."""

    @pytest.fixture
    def module(self):
        """Return a Greynoise Community module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
