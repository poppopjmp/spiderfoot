# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_talosintel.py
import pytest
...
# This test requires credentials for the Talosintel service
# To run this test, set the environment variables:
# - SF_SFP_TALOSINTEL_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TALOSINTEL_API_KEY']),
    reason="Integration test - requires Talosintel credentials"
)
class TestModuleIntegrationTalosintel:
    """Integration testing for the Talosintel module."""

    @pytest.fixture
    def module(self):
        """Return a Talosintel module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
