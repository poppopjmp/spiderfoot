# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_cybercrimetracker.py
import pytest
...
# This test requires credentials for the Cybercrimetracker service
# To run this test, set the environment variables:
# - SF_SFP_CYBERCRIMETRACKER_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_CYBERCRIMETRACKER_API_KEY']),
    reason="Integration test - requires Cybercrimetracker credentials"
)
class TestModuleIntegrationCybercrimetracker:
    """Integration testing for the Cybercrimetracker module."""

    @pytest.fixture
    def module(self):
        """Return a Cybercrimetracker module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
