# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_wikipediaedits.py
import pytest
...
# This test requires credentials for the Wikipediaedits service
# To run this test, set the environment variables:
# - SF_SFP_WIKIPEDIAEDITS_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_WIKIPEDIAEDITS_API_KEY']),
    reason="Integration test - requires Wikipediaedits credentials"
)
class TestModuleIntegrationWikipediaedits:
    """Integration testing for the Wikipediaedits module."""

    @pytest.fixture
    def module(self):
        """Return a Wikipediaedits module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
