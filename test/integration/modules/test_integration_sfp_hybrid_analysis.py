# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_hybrid_analysis.py
import pytest
...
# This test requires credentials for the H Ybrid Analysis service
# To run this test, set the environment variables:
# - SF_SFP_HYBRID_ANALYSIS_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_HYBRID_ANALYSIS_API_KEY']),
    reason="Integration test - requires H Ybrid Analysis credentials"
)
class TestModuleIntegrationhYbridAnalysis:
    """Integration testing for the H Ybrid Analysis module."""

    @pytest.fixture
    def module(self):
        """Return a H Ybrid Analysis module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
