# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_phishtank.py
import pytest
...
# This test requires credentials for the Phishtank service
# To run this test, set the environment variables:
# - SF_SFP_PHISHTANK_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_PHISHTANK_API_KEY']),
    reason="Integration test - requires Phishtank credentials"
)
class TestModuleIntegrationPhishtank:
    """Integration testing for the Phishtank module."""

    @pytest.fixture
    def module(self):
        """Return a Phishtank module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
