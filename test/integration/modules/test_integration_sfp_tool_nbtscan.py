# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_tool_nbtscan.py
import pytest
...
# This test requires credentials for the Tool Nbtscan service
# To run this test, set the environment variables:
# - SF_SFP_TOOL_NBTSCAN_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TOOL_NBTSCAN_API_KEY']),
    reason="Integration test - requires Tool Nbtscan credentials"
)
class TestModuleIntegrationToolNbtscan:
    """Integration testing for the Tool Nbtscan module."""

    @pytest.fixture
    def module(self):
        """Return a Tool Nbtscan module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
