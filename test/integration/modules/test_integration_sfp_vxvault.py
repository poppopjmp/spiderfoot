# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_vxvault.py
import pytest
...
# This test requires credentials for the Vxvault service
# To run this test, set the environment variables:
# - SF_SFP_VXVAULT_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_VXVAULT_API_KEY']),
    reason="Integration test - requires Vxvault credentials"
)
class TestModuleIntegrationVxvault:
    """Integration testing for the Vxvault module."""

    @pytest.fixture
    def module(self):
        """Return a Vxvault module."""
        sf = SpiderFoot({
            '_debug': True,
            '__logging': True,
            '__outputfilter': None,
