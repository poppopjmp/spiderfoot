# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_koodous.py
import pytest
...
# This test requires credentials for the Koodous service
# To run this test, set the environment variables:
# - SF_SFP_KOODOUS_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_KOODOUS_API_KEY']),
    reason="Integration test - requires Koodous credentials"
)
class TestModuleIntegrationKoodous:
    """Integration testing for the Koodous module."""

    @pytest.fixture
    def module(self):
        """Return a Koodous module."""
        sf = SpiderFoot({
            '_debug': True,
            '__logging': True,
            '__outputfilter': None,
