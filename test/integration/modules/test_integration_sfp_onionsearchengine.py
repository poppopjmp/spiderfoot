# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_onionsearchengine.py
import pytest
...
# This test requires credentials for the Onionsearchengine service
# To run this test, set the environment variables:
# - SF_SFP_ONIONSEARCHENGINE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_ONIONSEARCHENGINE_API_KEY']),
    reason="Integration test - requires Onionsearchengine credentials"
)
class TestModuleIntegrationOnionsearchengine:
    """Integration testing for the Onionsearchengine module."""

    @pytest.fixture
    def module(self):
        """Return a Onionsearchengine module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
