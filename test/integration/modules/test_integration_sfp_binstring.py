# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_binstring.py
import pytest
...
# This test requires credentials for the Binstring service
# To run this test, set the environment variables:
# - SF_SFP_BINSTRING_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_BINSTRING_API_KEY']),
    reason="Integration test - requires Binstring credentials"
)
class TestModuleIntegrationBinstring:
    """Integration testing for the Binstring module."""

    @pytest.fixture
    def module(self):
        """Return a Binstring module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
