# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_ipinfo.py
import pytest
...
# This test requires credentials for the I Pinfo service
# To run this test, set the environment variables:
# - SF_SFP_IPINFO_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_IPINFO_API_KEY']),
    reason="Integration test - requires I Pinfo credentials"
)
class TestModuleIntegrationiPinfo:
    """Integration testing for the I Pinfo module."""

    @pytest.fixture
    def module(self):
        """Return a I Pinfo module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
