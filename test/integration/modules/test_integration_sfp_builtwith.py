# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_builtwith.py
import pytest
...
# This test requires credentials for the Builtwith service
# To run this test, set the environment variables:
# - SF_SFP_BUILTWITH_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_BUILTWITH_API_KEY']),
    reason="Integration test - requires Builtwith credentials"
)
class TestModuleIntegrationBuiltwith:
    """Integration testing for the Builtwith module."""

    @pytest.fixture
    def module(self):
        """Return a Builtwith module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
