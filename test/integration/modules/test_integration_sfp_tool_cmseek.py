# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_tool_cmseek.py
import pytest
...
# This test requires credentials for the Tool Cmseek service
# To run this test, set the environment variables:
# - SF_SFP_TOOL_CMSEEK_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TOOL_CMSEEK_API_KEY']),
    reason="Integration test - requires Tool Cmseek credentials"
)
class TestModuleIntegrationToolCmseek:
    """Integration testing for the Tool Cmseek module."""

    @pytest.fixture
    def module(self):
        """Return a Tool Cmseek module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
