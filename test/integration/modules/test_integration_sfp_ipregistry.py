# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_ipregistry.py
import pytest
...
# This test requires credentials for the I Pregistry service
# To run this test, set the environment variables:
# - SF_SFP_IPREGISTRY_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_IPREGISTRY_API_KEY']),
    reason="Integration test - requires I Pregistry credentials"
)
class TestModuleIntegrationiPregistry:
    """Integration testing for the I Pregistry module."""

    @pytest.fixture
    def module(self):
        """Return a I Pregistry module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
