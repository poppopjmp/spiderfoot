# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_tool_whatweb.py
import pytest
...
# This test requires credentials for the Tool Whatweb service
# To run this test, set the environment variables:
# - SF_SFP_TOOL_WHATWEB_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TOOL_WHATWEB_API_KEY']),
    reason="Integration test - requires Tool Whatweb credentials"
)
class TestModuleIntegrationToolWhatweb:
    """Integration testing for the Tool Whatweb module."""

    @pytest.fixture
    def module(self):
        """Return a Tool Whatweb module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
