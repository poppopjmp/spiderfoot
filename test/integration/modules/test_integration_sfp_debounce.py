# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_debounce.py
import pytest
...
# This test requires credentials for the Debounce service
# To run this test, set the environment variables:
# - SF_SFP_DEBOUNCE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_DEBOUNCE_API_KEY']),
    reason="Integration test - requires Debounce credentials"
)
class TestModuleIntegrationDebounce:
    """Integration testing for the Debounce module."""

    @pytest.fixture
    def module(self):
        """Return a Debounce module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
