# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_uceprotect.py
import pytest
...
# This test requires credentials for the Uceprotect service
# To run this test, set the environment variables:
# - SF_SFP_UCEPROTECT_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_UCEPROTECT_API_KEY']),
    reason="Integration test - requires Uceprotect credentials"
)
class TestModuleIntegrationUceprotect:
    """Integration testing for the Uceprotect module."""

    @pytest.fixture
    def module(self):
        """Return a Uceprotect module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
