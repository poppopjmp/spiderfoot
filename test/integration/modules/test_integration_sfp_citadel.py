# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_citadel.py
import pytest
...
# This test requires credentials for the Citadel service
# To run this test, set the environment variables:
# - SF_SFP_CITADEL_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_CITADEL_API_KEY']),
    reason="Integration test - requires Citadel credentials"
)
class TestModuleIntegrationCitadel:
    """Integration testing for the Citadel module."""

    @pytest.fixture
    def module(self):
        """Return a Citadel module."""
        sf = SpiderFoot({
            '_debug': True,
            '__logging': True,
            '__outputfilter': None,
