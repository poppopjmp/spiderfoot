# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_greynoise.py
import pytest
...
# This test requires credentials for the Greynoise service
# To run this test, set the environment variables:
# - SF_SFP_GREYNOISE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_GREYNOISE_API_KEY']),
    reason="Integration test - requires Greynoise credentials"
)
class TestModuleIntegrationGreynoise:
    """Integration testing for the Greynoise module."""

    @pytest.fixture
    def module(self):
        """Return a Greynoise module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
