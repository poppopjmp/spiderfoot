# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_tool_onesixtyone.py
import pytest
...
# This test requires credentials for the Tool Onesixtyone service
# To run this test, set the environment variables:
# - SF_SFP_TOOL_ONESIXTYONE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TOOL_ONESIXTYONE_API_KEY']),
    reason="Integration test - requires Tool Onesixtyone credentials"
)
class TestModuleIntegrationToolOnesixtyone:
    """Integration testing for the Tool Onesixtyone module."""

    @pytest.fixture
    def module(self):
        """Return a Tool Onesixtyone module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
