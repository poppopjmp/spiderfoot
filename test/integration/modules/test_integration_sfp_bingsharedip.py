# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_bingsharedip.py
import pytest
...
# This test requires credentials for the Bingsharedip service
# To run this test, set the environment variables:
# - SF_SFP_BINGSHAREDIP_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_BINGSHAREDIP_API_KEY']),
    reason="Integration test - requires Bingsharedip credentials"
)
class TestModuleIntegrationBingsharedip:
    """Integration testing for the Bingsharedip module."""

    @pytest.fixture
    def module(self):
        """Return a Bingsharedip module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
