# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_googleobjectstorage.py
import pytest
...
# This test requires credentials for the Googleobjectstorage service
# To run this test, set the environment variables:
# - SF_SFP_GOOGLEOBJECTSTORAGE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_GOOGLEOBJECTSTORAGE_API_KEY']),
    reason="Integration test - requires Googleobjectstorage credentials"
)
class TestModuleIntegrationGoogleobjectstorage:
    """Integration testing for the Googleobjectstorage module."""

    @pytest.fixture
    def module(self):
        """Return a Googleobjectstorage module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
