# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_onyphe.py
import pytest
...
# This test requires credentials for the Onyphe service
# To run this test, set the environment variables:
# - SF_SFP_ONYPHE_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_ONYPHE_API_KEY']),
    reason="Integration test - requires Onyphe credentials"
)
class TestModuleIntegrationOnyphe:
    """Integration testing for the Onyphe module."""

    @pytest.fixture
    def module(self):
        """Return a Onyphe module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
