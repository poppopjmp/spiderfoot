# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_isc.py
import pytest
...
# This test requires credentials for the I Sc service
# To run this test, set the environment variables:
# - SF_SFP_ISC_API_KEY


@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_ISC_API_KEY']),
    reason="Integration test - requires I Sc credentials"
)
class TestModuleIntegrationiSc:
    """Integration testing for the I Sc module."""

    @pytest.fixture
    def module(self):
        """Return a I Sc module."""
        sf = SpiderFoot({
            '_debug': True,
            '__logging': True,
            '__outputfilter': None,
