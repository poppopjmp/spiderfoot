# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_googlesafebrowsing.py
import pytest
...
# This test requires credentials for the Googlesafebrowsing service
# To run this test, set the environment variables:
# - SF_SFP_GOOGLESAFEBROWSING_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_GOOGLESAFEBROWSING_API_KEY']),
    reason="Integration test - requires Googlesafebrowsing credentials"
)
class TestModuleIntegrationGooglesafebrowsing:
    """Integration testing for the Googlesafebrowsing module."""

    @pytest.fixture
    def module(self):
        """Return a Googlesafebrowsing module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
