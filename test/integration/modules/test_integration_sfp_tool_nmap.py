# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_tool_nmap.py
import pytest
...
# This test requires credentials for the Tool Nmap service
# To run this test, set the environment variables:
# - SF_SFP_TOOL_NMAP_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_TOOL_NMAP_API_KEY']),
    reason="Integration test - requires Tool Nmap credentials"
)
class TestModuleIntegrationToolNmap:
    """Integration testing for the Tool Nmap module."""

    @pytest.fixture
    def module(self):
        """Return a Tool Nmap module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
