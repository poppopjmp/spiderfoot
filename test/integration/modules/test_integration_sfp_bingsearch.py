# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_bingsearch.py
import pytest
...
# This test requires credentials for the Bingsearch service
# To run this test, set the environment variables:
# - SF_SFP_BINGSEARCH_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_BINGSEARCH_API_KEY']),
    reason="Integration test - requires Bingsearch credentials"
)
class TestModuleIntegrationBingsearch:
    """Integration testing for the Bingsearch module."""

    @pytest.fixture
    def module(self):
        """Return a Bingsearch module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
