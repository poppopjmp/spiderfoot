# filepath: /mnt/c/Users/van1sh/Documents/GitHub/spiderfoot/test/integration/modules/test_integration_sfp_deepinfo.py
import pytest
...
# This test requires credentials for the Deepinfo service
# To run this test, set the environment variables:
# - SF_SFP_DEEPINFO_API_KEY

@pytest.mark.skipif(
    not all(os.environ.get(env_var) for env_var in ['SF_SFP_DEEPINFO_API_KEY']),
    reason="Integration test - requires Deepinfo credentials"
)
class TestModuleIntegrationDeepinfo:
    """Integration testing for the Deepinfo module."""

    @pytest.fixture
    def module(self):
        """Return a Deepinfo module."""
        sf = SpiderFoot({
        '_debug': True,
        '__logging': True,
        '__outputfilter': None,
