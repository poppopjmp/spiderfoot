...
- All upsert/replace operations use PostgreSQL-native `ON CONFLICT` for correct, atomic updates.
...
- Connection pooling is recommended for high concurrency (e.g., using `psycopg2.pool`).
- Always back up your database before upgrading SpiderFoot.
